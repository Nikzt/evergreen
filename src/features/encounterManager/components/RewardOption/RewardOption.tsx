...
import { Power, Consumable, Reward, getRewardDescription } from '../../rewards';
...
const RewardOption = ({reward}: RewardOptionProps) => {
    ...
    const onRewardClick = () => {
        if (reward.value.unitId != null)
            dispatch(updateUnitWithReward({unitId: reward.value.unitId, reward}));
    }
